...
var helpLines = []string{
	...
	"  Ctrl+Space  Open/force suggestions (auto-completes if there's one match)",
	...
	"  F1          Cycle the buttons: Delete, Reset, Connect, Cancel",
	"              (Reset clears the form; Delete, set apart at the",
	"              left, removes the highlighted saved connection",
	"              after confirming)",
